    ...
    <div style="height: 100%;">
        ...
        <div class="flex flex-row justify-between">
            <div class="flex flex-col w-1/4 border border-gray-700 border-dimmded rounded pt-3 pb-3 bg-green-700 m-1">
                ...
                <div class="font-small text-xs text-center">HTTPS</div>
            </div>
            <div class="flex flex-col w-1/4 border border-gray-700 border-dimmded rounded pt-3 pb-3 bg-red-700 m-1">
                <div class="font-small text-xs text-center"></div>
                <div class="font-small text-xs text-center">HTTP</div>
            </div>
        </div>

        <div class="h-56 flex mt-3">
          <ul class="h-48 w-full m-auto overflow-y-scroll">
            <div class="text-center @if($brokenLinks <= 0) block @else hidden @endif">No broken links</div>
          
            <div class="flex flex-row justify-between py-1 relative">
                <div class="flex flex-col w-2/3 items-center text-xs relative">
                    <div class="p-1 w-full text-left"></div>
                </div>
                <div class="flex flex-row w-auto ml-1 text-xs justify-end">
                    <div class="p-1 rounded bg-red-600 text-center w-10"></div>
                </div>
            </div>
